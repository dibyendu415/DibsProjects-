...
*/
// am using FAST I/O, using scanf & printf instead cin && cout can reduce the time taken to take input significantly. this can be used in questions requiring taking input of many large integers
int main()
